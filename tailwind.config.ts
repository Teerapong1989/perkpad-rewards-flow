...
export default {
	...
	theme: {
		...
		extend: {
			fontFamily: {
				sans: ['Inter', 'Inter-system-fallback', 'Inter-fallback', 'system-ui', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto', 'sans-serif'],
				display: ['Inter', 'Inter-system-fallback', 'Inter-fallback', 'system-ui', 'sans-serif'],
			},
			fontSize: {
