...
import { QrCode, Smartphone, BarChart3, Gift, Check, Star, ArrowRight, Users, Zap, Shield } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="space-y-4">
                <h1 className="text-5xl lg:text-6xl font-bold text-slate-800 leading-tight">
                  ...
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-orange-400">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="bg-teal-600 hover:bg-teal-700 text-lg px-8 py-6 rounded-xl">
                  Get Started Free
            ...
            <div className="relative">
              <div className="relative bg-white rounded-3xl shadow-2xl p-8 max-w-sm mx-auto">
                <div className="bg-gradient-to-br from-teal-500 to-teal-600 rounded-2xl p-6 text-white text-center mb-6">
                  <QrCode className="w-24 h-24 mx-auto mb-4" />
                  <p className="font-semibold">Scan to collect stamps!</p>
                </div>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="font-medium text-slate-700">Progress</span>
                    <span className="text-teal-600 font-bold">7/10 stamps</span>
                  </div>
                  <div className="grid grid-cols-5 gap-2">
                    {[1,2,3,4,5,6,7].map((i) => (
                      <div key={i} className="w-8 h-8 bg-teal-100 rounded-full flex items-center justify-center">
                        <Check className="w-4 h-4 text-teal-600" />
                      </div>
                    ))}
                    {[8,9,10].map((i) => (
                  ...
                  <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 text-center">
                    <p className="text-orange-700 font-medium">3 more visits for a free coffee! ☕</p>
                  </div>
                </div>
              </div>
            </div>
